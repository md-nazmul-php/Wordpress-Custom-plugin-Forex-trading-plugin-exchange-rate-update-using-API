...
<hr>
    ...
    <h2 style="text-align: center;">Short Protfolio</h2><br>
   <p style="text-align: center;">Use currency name like <b>USDCAD</b> it mean USD to CAD conversion </p><br> <p style="text-align: center;">Always use upercase for the currency name and Action like SELL/BUY and USDEUR nut use buy/sell or usdeur</p><br>
     ...
     <p style="text-align: center;">Use shortcode <b>[fx-table-short]</b> any where in your page and posts to display the table. </p><br>
          ...
          foreach ($result as $print) {
            echo "
              <tr>
                ...
                <td width='15%'><a href='admin.php?page=fx-table%2Fmain.php%2Fshort&upt=$print->id'><button type='button'>Edit </button></a>
          ...
          <tbody>
            <form action='' method='post'>
              <tr>
                ...
                <td width='10%'><button id='uptsubmit' name='uptsubmit' type='submit'>UPDATE</button> <a href='admin.php?page=fx-table%2Fmain.php%2Fshort'><button type='button'>CANCEL</button></a></td>
