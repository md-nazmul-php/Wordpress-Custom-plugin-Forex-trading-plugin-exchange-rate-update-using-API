...
$table_name = $wpdb->prefix . 'longfxdatatable';
 ...
 echo '<h3 id="longtitletlb" style="text-align:center;font-weight:700;font-size:24px;">';?>
...
echo(date("d-m-y"));
 ...
 <p style="text-align:center;font-weight:700;font-size:24px;padding-top:10px;">Long-term Portfolio</p>
</h3>
...
function convertCurrencyn($amount,$from_currency,$to_currency){
   ...
   return number_format($total, 4, '.', '');
    ...
    $result = $wpdb->get_results("SELECT * FROM $table_name");
         ...
         $position_size = $print->position_size;
          ...
          $market_price=convertCurrencyn(1, 'CAD','USD'); 
            
         }
         elseif ($currencyname=='USDCAD') {

            $market_price=convertCurrencyn(1, 'USD','CAD'); 

          }

         elseif ($currencyname=='USDCHF') {

           $market_price=convertCurrencyn(1, 'USD','CHF'); 
         ...
         elseif ($currencyname=='NZDUSD') {
           ...
           $market_price=convertCurrencyn(1, 'NZD','USD');
         ...
         elseif ($currencyname=='USDJPY') {
           ...
           $market_price=convertCurrencyn(1, 'USD','JPY');
           ...
           $market_price=convertCurrencyn(1, 'EUR','USD');

                    }

                    elseif ($currencyname=='USDEUR') {
          
           $market_price=convertCurrencyn(1, 'USD','EUR');
           ...
           $market_price=convertCurrencyn(1, 'GBP','USD');

                    }

                    elseif ($currencyname=='CADJPY') {
          
           $market_price=convertCurrencyn(1, 'CAD','JPY');

                    }

                    elseif ($currencyname=='AUDUSD') {
          
           $market_price=convertCurrencyn(1, 'AUD','USD');

                    }

                    elseif ($currencyname=='EURJPY') {
          
           $market_price=convertCurrencyn(1, 'EUR','JPY');

                    }

                    elseif ($currencyname=='NZDJPY') {
          
           $market_price=convertCurrencyn(1, 'NZD','JPY'); 
           ...
           $market_price=convertCurrencyn(1, 'AUD','JPY'); 
           ...
           $market_price=convertCurrencyn(1, 'GBP','JPY'); 

                    }

                    elseif ($currencyname=='CHFJPY') {
          
           $market_price=convertCurrencyn(1, 'CHF','JPY'); 
           ...
           $market_price=convertCurrencyn(1, 'EUR','GBP'); 
           ...
           $market_price=convertCurrencyn(1, 'EUR','CHF'); 

                    }

                    elseif ($currencyname=='GBPCHF') {
          
           $market_price=convertCurrencyn(1, 'GBP','CHF'); 
           ...
           $market_price=convertCurrencyn(1, 'AUD','CAD'); 
           ...
           $market_price=convertCurrencyn(1, 'NZD','CAD'); 
           ...
           $market_price=convertCurrencyn(1, 'CAD','CHF'); 

                    }

                    elseif ($currencyname=='GBPCAD') {
          
           $market_price=convertCurrencyn(1, 'GBP','CAD');
           ...
           $market_price=convertCurrencyn(1, 'CHF','NZD');
           ...
           $market_price=convertCurrencyn(1, 'NZD','CHF');
           ...
           $market_price=convertCurrencyn(1, 'EUR','CAD');

                    }

                    elseif ($currencyname=='EURAUD') {
          
           $market_price=convertCurrencyn(1, 'EUR','AUD');

                    }

                    elseif ($currencyname=='EURNZD') {
          
           $market_price=convertCurrencyn(1, 'EUR','NZD');
           ...
           $market_price=convertCurrencyn(1, 'GBP','AUD');
           ...
           $market_price=convertCurrencyn(1, 'GBP','NZD');
           ...
           $market_price=convertCurrencyn(1, 'AUD','NZD');
           ...
           $market_price=convertCurrencyn(1, 'AUD','CHF');
...
add_shortcode('fx-table-long', 'wpb_fx_shortcode'); 